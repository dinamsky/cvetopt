...
$MESS["WIZ_TEMPLATE_ADAPT_HORIZONTAL"] = "Универсальный, настраеваемый шаблон.";
$MESS["WIZ_TEMPLATE_ADAPT_DESCRIPTION"] = "В настройках шаблона вы всегда можете изменить:
<ul>
	<li>Тему (светлая\темная)</li>
	<li>Цветовую схему</li>
	<li>Вид меню</li>
	<li>Что показывать на главной странице</li>
</ul> ";
...
$MESS["WIZ_COMPANY_LOGO"] = "Логотип (рекомендуемый размер 180 X 50)";
...
$MESS["WIZ_COMPANY_NAME_DEF"] = " Магазин одежды и обуви";
$MESS["WIZ_COMPANY_TELEPHONE"] = "Телефон для обратной связи";
$MESS["WIZ_COMPANY_TELEPHONE_DEF"] = "+7(927) 567 14 37";
...
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; Универсальный интернет-магазин для продажи любых видов товаров, 2017";
$MESS["WIZ_REWRITE_INDEX_DESC"] = "Изменение главной страницы";
$MESS["wiz_site_name"] = "Интернет-магазин одежды";
...
$MESS["WIZ_SHOP_OF_NAME_DEF"] = "ООО \"Интернет-магазин одежды\"";
...
$MESS["WIZ_SHOP_ADR_DEF"] = "г. Москва, ул. Ильинка, 98";
...
$MESS["wiz_site_desc"] = "Мы предлагаем широкий ассортимент одежды и обуви";
$MESS["wiz_keywords"] = "одежды обувь ремни";
