...
<script type="text/javascript">
  ...
  <?
  $arr_url = explode('/', str_replace ( SITE_DIR,"/", $_SERVER['HTTP_REFERER']));
  $url_back = $arr_url[3];
  ?>

<?

if( $url_back == 'catalog' || $url_back == "")
{
 $_SESSION['url_back'] =  $_SERVER['HTTP_REFERER'];
} else {
...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	{
		?>
		<div style="margin-top: 35px;"><? $APPLICATION->IncludeComponent("bitrix:sale.gift.basket", "cart", Array(
