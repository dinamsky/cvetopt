		...
		<tbody>
			...
			?>
				<tr id="<?=$arItem["ID"]?>">
					...
					?>
						<td class="control">
							<a class="btn btn-info btn-sm btn_car" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["add"])?>"><i class="fa fa-level-up"></i> <?=GetMessage("SALE_ADD_TO_BASKET")?></a>
							<?
							if ($bDeleteColumn):
							?>
								<a class="btn btn-info btn-sm btn_car" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"><i class="fa fa-trash-o"></i> <?=GetMessage("SALE_DELETE")?></a><br />
							<?
							endif;
							?>
						</td>
