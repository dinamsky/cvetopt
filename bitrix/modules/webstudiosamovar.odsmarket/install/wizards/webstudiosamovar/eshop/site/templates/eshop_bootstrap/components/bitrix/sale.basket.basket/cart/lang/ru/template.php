<?
$MESS["SALE_ORDER"] = "<i class=\"fa fa-check\"></i> Оформить заказ";
$MESS["BACK_SHOP"] = "<i class=\"fa fa-level-up\"></i> Продолжить покупки";
...
$MESS["SALE_COUPON_APPLY"] = "<i class=\"fa fa-angle-right\"></i>";
