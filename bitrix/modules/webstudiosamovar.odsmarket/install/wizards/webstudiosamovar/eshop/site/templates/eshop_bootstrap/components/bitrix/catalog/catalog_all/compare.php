...
// echo "<pre>";
// print_r($arParams["COMPARE_FIELD_CODE"]);
// echo "</pre>";

?>
<?

$name = isset($_GET['fav']) ?  'CATALOG_FAV_LIST' : $arParams["COMPARE_NAME"];

$shablon = isset($_GET['fav']) ? 'fav' : '';

$arr_fields = isset($_GET['fav']) ?  Array("PREVIEW_TEXT","DETAIL_PICTURE","") : $arParams["COMPARE_FIELD_CODE"];
