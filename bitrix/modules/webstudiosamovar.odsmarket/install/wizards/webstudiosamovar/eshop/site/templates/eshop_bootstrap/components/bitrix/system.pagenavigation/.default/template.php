...
<div class="col-md-7 col-sm-7 col-xs-7" style="<?=$style_no_pagin?>">
...
?>
			...
			<a class="modern-page-previous" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><i class='fa fa-chevron-left'></i></a>
<?
		else:
			if ($arResult["NavPageCount"] == ($arResult["NavPageNomer"]+1) ):
?>
			<a class="modern-page-previous" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><i class='fa fa-chevron-left'></i></a>
<?
			else:
?>
			<a class="modern-page-previous" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><i class='fa fa-chevron-left'></i></a>
...
?>
		<a class="modern-page-next"href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><i class='fa fa-chevron-right'></i></a>
<?
	endif; 
...
<div class="col-md-5 col-lg-5 col-xs-5 col-sm-5 <?if(!$style_no_pagin):?>text-right<?endif?> hidden-xs">
	
<?
$zapros=$_SERVER['REQUEST_URI'];
$kol_tovar_pagecatalog = kol_tovar_page();
?>
<nav >
<ul class="pagination pagination-sm">	
<?
$ar_kol = array('kol' => 30, 'PAGEN_3' => 1, 'PAGEN_2' => 1);
$url = urlReplaceArg($zapros, $ar_kol);
?>
<li <?if($kol_tovar_pagecatalog == 30):?>class="active"<?endif?>><a href="<?=$url?>">30</a></li>
<?
$ar_kol = array('kol' => 60, 'PAGEN_3' => 1, 'PAGEN_2' => 1);
$url = urlReplaceArg($zapros, $ar_kol);
?>
<li <?if($kol_tovar_pagecatalog == 60):?>class="active"<?endif?>><a href="<?=$url?>">60</a></li>
<?
$ar_kol = array('kol' => 120, 'PAGEN_3' => 1, 'PAGEN_2' => 1);
$url = urlReplaceArg($zapros, $ar_kol);
?>
<li <?if($kol_tovar_pagecatalog == 120):?>class="active"<?endif?>><a href="<?=$url?>">120</a></li>
<?
$ar_kol = array('kol' => 180, 'PAGEN_3' => 1, 'PAGEN_2' => 1);
$url = urlReplaceArg($zapros, $ar_kol);
?>
<li <?if($kol_tovar_pagecatalog == 180):?>class="active"<?endif?>><a href="<?=$url?>">180</a></li>
