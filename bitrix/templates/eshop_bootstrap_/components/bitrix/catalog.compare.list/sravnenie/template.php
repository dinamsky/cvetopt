...
$style = ($itemCount == 0 ? ' style="display: block;"' : '');
// $style = '';
?>
...
<a href="<? echo $arParams["COMPARE_URL"]; ?>">
<i class="demo-icon icon-balance-scale"></i>
<?
if ($itemCount > 0)
{
	?>
    <span class="kol" id="<? echo $idCompareAll; ?>"><? echo $itemCount; ?></span>
<?
}
?>
<div  class="hidden-xs"><?=getmessage("title_sravn")?></div>
</a>
