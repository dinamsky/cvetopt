...
<?
$pict = $arResult['PREVIEW_PICTURE']['SRC'] ? $arResult['PREVIEW_PICTURE']['SRC'] : $arResult['DETAIL_PICTURE']['SRC'];
?>

<a href="<?= $arResult['DETAIL_PAGE_URL']?>">
          <div  id="<? echo $arItemIDs['PICT']; ?>" style="background: url(<?=$pict?>) no-repeat center center; background-size: contain; height: 260px; width: auto; margin-bottom: 20px;">
          </div>
...
if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT'])
{
	if (!isset($arResult['OFFERS']) || empty($arResult['OFFERS']))
	{
		...
		{
?>
	<div class="tovar_one_skidka" id="<? echo $arItemIDs['DISCOUNT_PICT_ID'] ?>"><? echo -$arResult['MIN_PRICE']['DISCOUNT_DIFF_PERCENT']; ?>%1</div>
<?
		}
	}
	else
	{
?>
	<div class="tovar_one_skidka" id="<? echo $arItemIDs['DISCOUNT_PICT_ID'] ?>" style="display: none;"></div>
<?
	}
}
?>
...
?>
	...
	<div class="osn_price" id="<? echo $arItemIDs['PRICE']; ?>"><? echo $minPrice['PRINT_DISCOUNT_VALUE']; ?></div>
<?
...
{
?>
	<div class="old_price" id="<? echo $arItemIDs['OLD_PRICE']; ?>" style="display: <? echo($boolDiscountShow ? '' : 'none'); ?>"><? echo($boolDiscountShow ? $minPrice['PRINT_VALUE'] : ''); ?></div>
<?
}
?>
</div>
...
if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS']) && !empty($arResult['OFFERS_PROP']))
{
	$arSkuProps = array();
?>
<div class="item_info_section" style="padding-right:150px; display: none;" id="<? echo $arItemIDs['PROP_DIV']; ?>">
<?
