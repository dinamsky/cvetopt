									...
									<div class="col-xs-10 col-xs-offset-1 bx-ui-slider-track-container">
										<div class="bx-ui-slider-track" id="drag_track_<?=$key?>">
											...
											<div class="bx-ui-slider-range" id="drag_tracker_<?=$key?>"  style="left: 0%; right: 0%;">
												...
												style="right:0;" href="javascript:void(0)" id="right_slider_<?=$key?>">
									...
									<div class="col-xs-10 col-xs-offset-1 bx-ui-slider-track-container">
										<div class="bx-ui-slider-track" id="drag_track_<?=$key?>">
											...
											<div class="bx-ui-slider-range" 	id="drag_tracker_<?=$key?>"  style="left: 0;right: 0;">
												...
												left:0;
												"
												href="javascript:void(0)" id="left_slider_<?=$key?>"><i class="fa fa-angle-left"></i></a>
												<a class="bx-ui-slider-handle right" style="right:0;" href="javascript:void(0)" id="right_slider_<?=$key?>"><i class="fa fa-angle-right"></i></a>
											</div>
										</div>
									</div>
									<?
						...
						<div class="bx-filter-parameters-box-container">
							...
							<div class="btn-group btn-group-justified" role="group" aria-label="temp">
								<div class="btn-group" role="group">
									<button class="btn btn-default btn-sm" type="submit" id="set_filter" name="set_filter"><i class="fa fa-check"></i> <?=GetMessage("CT_BCSF_SET_FILTER")?></button>
								</div>
								<div class="btn-group" role="group">
									<button class="btn btn-sm" type="submit" id="del_filter" name="del_filter"><i class="fa fa-times"></i> <?=GetMessage("CT_BCSF_DEL_FILTER")?></button> 
								</div>
							</div>
							...
							<div class="bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
								...
								<br/>
								<a class="btn show_rez" href="<?echo $arResult["FILTER_URL"]?>" target=""><?echo GetMessage("CT_BCSF_FILTER_SHOW")?></a>
							</div>
						</div>
