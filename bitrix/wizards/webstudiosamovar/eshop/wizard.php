...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	function InitStep()
	{
		...
		$this->SetNextStep("site_settings"); // Я добавил
	...
	//	$this->content .= "<input type='hidden' value='eshop' name='templateID' id='templateID'>";//$this->ShowInputField('hidden', 'templateID', array("id" => "templateID", "value" => "eshop"));
		...
		foreach ($arTemplateOrder as $templateID)
		{
			...
			$this->content .= '<label for="'.$templateID.'" class="inst-template-list-label">'.$arTemplate["NAME"];
			$this->content .= '<br><br><div style="font-size: 12px">'.$arTemplate["DESCRIPTION"].'</div>';
			$this->content .= "</label></div>";
		}
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$this->SetPrevStep("select_template");  // Я добавил
		...
		$wizard->SetDefaultVars(Array(
			...
			"siteLogo" =>  $wizard->GetPath()."/site/templates/eshop_bootstrap/images/".LANGUAGE_ID."/logo.png",
		...
		$wizard->SetDefaultVars(
			Array(
				"siteName" => $this->GetFileContent(WIZARD_SITE_PATH."include/index_company_name.php", GetMessage("WIZ_COMPANY_NAME_DEF")),
				"siteSchedule" => $this->GetFileContent(WIZARD_SITE_PATH."include/index_footer_regim.php", GetMessage("WIZ_COMPANY_SCHEDULE_DEF")),
				"siteTelephone" => $this->GetFileContent(WIZARD_SITE_PATH."include/index_header_tel.php", GetMessage("WIZ_COMPANY_TELEPHONE_DEF")),
				"siteCopy" => $this->GetFileContent(WIZARD_SITE_PATH."include/index_footer_copyr.php", GetMessage("WIZ_COMPANY_COPY_DEF")),
...
class ShopSettings extends CWizardStep
{
	...
	function ShowStep()
	{
		...
		{
			$this->content .=
				'<div class="wizard-catalog-title" style="display: none">'.GetMessage("WIZ_SHOP_LOCALIZATION").'</div>
				<div class="wizard-input-form-block"  style="display: none">'.
...
===*/
	...
	function ShowStep()
	{
		...
		$this->content .= '
		<div>
			<div class="wizard-catalog-title" style="display: none">'.GetMessage("WIZ_LOCATION_TITLE").'</div>
			<div>
				<div class="wizard-input-form-field wizard-input-form-field-checkbox"  style="display: none">';
